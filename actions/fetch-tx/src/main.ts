...
import { type ExtendedSafeTransaction, loadChainId, loadNextTxs, loadSafeInfo } from "shared-utils";
import { findToExecute } from "./utils";

const processFetchTx = async (
	serviceUrl: string,
	safeAddress: string,
	safeTxHash?: string,
): Promise<{ safeTx: ExtendedSafeTransaction | null }> => {
